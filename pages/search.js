...
export default function SearchForm() {
  ...
  let queryString = "";
  // getting a reference to the searchHistoryAtom

  const submitForm = async (data) => {
    const { q, searchBy, geoLocation, medium, isHighlight, isOnView } = data;

    // Construct the query string based on form data
    ...
    // Redirect to the artwork search results page with query parameters
